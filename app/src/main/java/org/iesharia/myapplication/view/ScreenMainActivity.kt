                ...
                onClick = {
                    ...
                    cursor?.let {
                        if (cursor.moveToFirst()) {
                            do {
                                val id = cursor.getInt(cursor.getColumnIndex(DBHelper.Companion.ID_COL))
                                val name = cursor.getString(cursor.getColumnIndex(DBHelper.Companion.NAME_COl))
                                val age = cursor.getString(cursor.getColumnIndex(DBHelper.Companion.AGE_COL))
